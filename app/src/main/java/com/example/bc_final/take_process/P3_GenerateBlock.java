...
public class P3_GenerateBlock {
    private final Receiver receiver;
    private static P3_GenerateBlock instance;
    private static final String TAG = "Generate New Block Process.";
    private boolean isRunning;

    private P3_GenerateBlock() {
        this.receiver = Own.getReceiver(2);
        this.isRunning = false;
    }

    public static synchronized P3_GenerateBlock getInstance() {
        if (instance == null) {
            instance = new P3_GenerateBlock();
        }
        return instance;
    }
